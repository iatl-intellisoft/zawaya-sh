...
class HrContract(models.Model):
	...
	# 		return self.env.ref('zaway_hr_contract.structure_alwatania_contrect_details').id
	# 	elif self.company_id.id == self.env.ref('base_custom.aldowlia_company').id:
	# 		return self.env.ref('zaway_hr_contract.structure_aldowlia_contrect_details').id
	# 	elif self.company_id.id == self.env.ref('base_custom.ajwaa_company').id:
	# 		return self.env.ref('zaway_hr_contract.structure_ajwaa_contrect_details').id
	# 	else:
	# 		return self.env.ref('zaway_hr_contract.structure_employee_contrect_details').id
